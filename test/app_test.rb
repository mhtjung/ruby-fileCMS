...
# Problem - Write tests for the routes that the application already supports.
  # get "/"
  # get "/:filname"
...
class CMSTest < Minitest::Test
  ...
  def test_md
    ...
    get "/about.md" # fetching an md file

    assert_equal 200, last_response.status # Assert that request was successful
    assert_equal "text/html;charset=utf-8", last_response["Content-Type"]
